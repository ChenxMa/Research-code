...
def show_nii_gif(nii_file, save_path="D:\T2_FLAIR\\1000336_20253_2_0\\array.gif", show_frame=True):
    """
    @Brife:
    ...
    # Image.ROTATE_90(imgs)
    # 保存
    # duration is the number of milliseconds between frames; this is 40 frames per second
    imgs[0].save(save_path, save_all=True, append_images=imgs[1:], duration=50, loop=0)


show_nii_gif(nii_file='D:\T2_FLAIR\\1000336_20253_2_0\T2_FLAIR\T2_FLAIR.nii.gz')
